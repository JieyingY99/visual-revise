...
const SUITES = ['smoke', 'core', 'toolbar', 'controls', 'panel', 'figma', 'typography', 'layout', 'grid', 'resizing', 'fill', 'image-fill', 'swap-image', 'text', 'list', 'list-follow', 'comment', 'comment-refs', 'removal', 'reanchor', 'tree', 'keymove', 'zoom', 'paste', 'resize-undo', 'copy-props', 'copy-image', 'replace-element', 'units', 'page-colors', 'history', 'guides', 'drag', 'advanced',
